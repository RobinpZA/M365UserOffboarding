<#
.SYNOPSIS
    Build script for M365UserOffboarding. Bootstraps dependencies and runs build tasks.
.PARAMETER Task
...
param(
    ...
    [ValidateSet('Analyze', 'Test', 'Build', 'Clean', 'CI')]
    [string]$Task
)

$ErrorActionPreference = 'Stop'

$moduleName  = 'M365UserOffboarding'
...
function Install-BuildDependency {
    $modules = @(
        ...
        @{ Name = 'DLLPickle';                      MinimumVersion = '1.0.0' }
    )
...
Write-Host "M365UserOffboarding Build Script" -ForegroundColor Cyan
